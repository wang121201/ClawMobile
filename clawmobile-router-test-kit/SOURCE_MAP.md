...
| `configs/router-*.json` | corresponding `work/router-*.json` files | Byte-identical frozen config copies, organized under `configs/` for publication |
| `configs/unified-five-group-experiment-v4.json` | `work/unified-five-group-experiment-v4.json` | Byte-identical frozen four-group Full/Filter baseline config copy |
