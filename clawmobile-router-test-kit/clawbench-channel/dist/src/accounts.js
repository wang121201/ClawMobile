...
const { listAccountIds: listClawBenchChannelAccountIds, resolveDefaultAccountId: resolveDefaultClawBenchChannelAccountId, } = createAccountListHelpers("clawbench", { normalizeAccountId });
export { listClawBenchChannelAccountIds, resolveDefaultClawBenchChannelAccountId };
function resolveMergedClawBenchAccountConfig(cfg, accountId) {
    return resolveMergedAccountConfig({
        channelConfig: cfg.channels?.clawbench,
