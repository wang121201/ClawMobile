...
import { DEFAULT_ACCOUNT_ID, listClawBenchChannelAccountIds, resolveClawBenchChannelAccount, resolveDefaultClawBenchChannelAccountId, } from "./accounts.js";
...
export const clawBenchChannelPlugin = createChatChannelPlugin({
    base: {
        id: CHANNEL_ID,
        meta,
        capabilities: {
    ...
    outbound: {
        ...
        attachedResults: {
            channel: CHANNEL_ID,
            sendText: async ({ cfg, to, text, accountId }) => await sendClawBenchChannelText({
                cfg: cfg,
                accountId,
                to,
                text,
